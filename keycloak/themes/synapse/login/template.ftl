...
<head>
    ...
    <link rel="icon" href="${url.resourcesPath}/img/synapse-logo.svg" type="image/svg+xml" />
...
<body id="keycloak-bg" class="${properties.kcBodyClass!} synapse-login-body">
...
>
  <div class="synapse-login-wrap">
  <div class="pf-v5-c-login__container">
    <main class="pf-v5-c-login__main synapse-login-card">
      <header class="pf-v5-c-login__main-header">
        <div class="synapse-login-header-slot"><#nested "header"></div>
